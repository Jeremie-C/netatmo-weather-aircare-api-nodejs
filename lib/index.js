 ...
 */
const SCOPE_WEATHER = 'read_station'
/**
 * Basic scope for AirCare
 */
const SCOPE_AIRCARE = 'read_homecoach'
/**
 * Full scope for this library
 */
const SCOPE_FULL = 'read_station read_homecoach'
...
class NetatmoClient {
  ...
  async getHomes (homeId = null, size = 30) {
    ...
    return (await this.request(HTTP_GET, '/api/homesdata', params, null)).body
  }
  ...
  async getHomeCoachData (deviceId) {
    ...
    return (await this.request(HTTP_GET, '/api/gethomecoachsdata', params, null)).body
  }
}

module.exports = { NetatmoClient, SCOPE_WEATHER, SCOPE_AIRCARE, SCOPE_FULL }
